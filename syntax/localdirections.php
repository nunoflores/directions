<?php
/**
 * directions Plugin - local directions component
 *   - shows, for the current wiki page, where, within the wiki, wikinauts come from and go to :).
 *
 * Usage: <localdirections>
 *
 ...
 */
class syntax_plugin_directions_localdirections extends DokuWiki_Syntax_Plugin {
   ...
   function getInfo() {
    return array(
            ...
            'name'   => 'directions Plugin (localdirections component)',
            'desc'   => 'shows, for the current wiki page, where, within the wiki, wikinauts come from and go to.',
...
//    }
    ...
    */
    function connectTo($mode) {
      $this->Lexer->addSpecialPattern('<(?|localdirections|localdirections graph)>',$mode,'plugin_directions_localdirections');
    }
